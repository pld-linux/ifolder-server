...
iFolder to proste i bezpieczne rozwiązanie przechowywania danych
zwiększające produktywność pozwalając zapisywać, odczytywać i
zarządzać swoimi plikami z dowolnego miejsca w dowolnym czasie. Po
zainstalowaniu iFoldera wystarczy zapisywać swoje pliki lokalnie, tak
jak zawsze, a iFolder automatycznie uaktualni pliki na serwerze
sieciowym i dostarczy je na inne używane przez nas maszyny.

Projekt iFolder, sponsorowany przez Novella, jest stworzony w oparciu
o środowisko mono/.NET tak, aby integrował się z istniejącymi
środowiskami biurowymi.
...
Ten pakiet zawiera pliki nagłówkowe biblioteki simias.
